export const relazioni = [
	{
		...
		type: "audio",
		fileType: "Audio",
		title: "Bar Locanda alla Mano",
		personName: "Bar Locanda alla Mano",
...

	{
		...
		hoverLabel: "Audio",
		hoverText: "Mi piace questa cosa di condividere oggetti.",
		hoverCredit: "Isacco",

		detailText: `Pur non avendo seguito le gare, ho vissuto molto positivamente la presenza di più persone e turisti in città. 
        Mi piace parlare con le persone, mi fa tanto piacere vederne tante.
        Questo scambio delle spille mi piace tantissimo. È una cosa bella. 
        Mi piace questa cosa di condividere le cose.`,
...

    {
        ...
        You could connect with people from America, China, Australia… The whole world was in Milan.`,
...

    {
        ...
        Le spille sono state uno strumento utile per conoscere persone. 
        Io ho parlato con degli atleti canadesi di snowboard, anche loro stavano pescando. 
        Abbiamo chiacchierato in inglese. Questo mi è rimasto molto.
        Fa piacere vedere tante persone anche dall’estero che vengono per l’evento.
        Ti permette di conoscere persone.`,
...

    {
        ...
        Può succedere ovunque, per strada, nei ristoranti, nelle venue.
        Lo scambio di spille è qualcosa che nasce e dal confronto.
        Spesso lo scambio non è formale: alcune persone chiedono direttamente una spilletta, oppure si creano piccole dinamiche di relazione, come quando una spilletta viene regalata dopo aver aiutato qualcuno.`,
...

    {
        ...
        A volte lo scambio non è solo di spille, ma anche di piccoli regali, dolci o snack.
        Ho conosciuto un allenatore coreano di curling che parlava con chiunque per scambiare spille.
        Le interazioni non sono localizzate, ma diffuse in tutto il sistema olimpico, rendendo ogni luogo un possibile punto di contatto.`,
...

    {
        ...
        Se dovessi descrivere la mia esperienza delle Olimpiadi con due parole sarebbero: PERSONE NUOVE.
        Durante le Olimpiadi ho vissuto per un paio di settimane nella mia seconda casa di Bormio; ho avuto qualche disagio per le restrizioni per i movimenti in auto.`,
...

    {
        ...
        Dopo le Olimpiadi mi è rimasto molto chiaro il ricordo della vita di un’atleta, tra sacrifici e sogni. 
        Se dovessi descrivere la mia esperienza delle Olimpiadi con delle parole sarebbero: IMPEGNO, SACRIFICI e SODDISFAZIONI.
        Le Olimpiadi hanno cambiato un po’ il modo in cui ho vissuto la città di Milano: ero stato a Milano pochi mesi prima dell’inizio delle Olimpiadi Invernali Milano-Cortina 2026, e già in alcune vie si respirava quell’atmosfera: tra installazioni con le mascotte e negozi pieni di gente, sembrava che la città fosse già pronta a viverle.`,
...

    {
        ...
        Ho avuto contatti indiretti con nuove persone su TikTok commentando video su determinate performance sportive. 
        Ciò che più mi è rimasto è il ricordo delle performance di pattinaggio artistico.`,
...

    {
		...
		hoverLabel: "Testo",
		hoverText: "Queste Olimpiadi mi hanno lasciato felicità.",
		hoverCredit: "Daniele",

		detailText: `Le Olimpiadi Milano-Cortina 2026 sono state una festa globale che ha unito grazie allo sport. 
        A me è capitato qualche volta di interagire con persone nuove all'entrata e uscita dei luoghi di gara. 
        Queste Olimpiadi mi hanno lasciato la felicità di averle vissute dal vivo vicino ai luoghi dove abito e lavoro (percorso della fiamma, il braciere e le gare sugli spalti).`,
...

    {
        ...
        Quello che più mi hanno lasciato le Olimpiadi è una città più socievole. 
        Durante il periodo delle Olimpiadi, le nuovi costruzioni realizzate per questo evento hanno fortemente attirato la mia attenzione, mi sono soffermato in più luoghi della mia città che solitamente erano per me unicamente di passaggio.`,
...

    {
		...
		hoverLabel: "Testo",
		hoverText: "Volontari e atleti sono persone come altre.",
		hoverCredit: "Carlotta",

		detailText: `Ho seguito le Olimpiadi in presenza, sui social media e da volontaria del Team26, perché sono appassionata di sport invernali. 
        Mi è capitato spesso di interagire con persone nuove grazie alle Olimpiadi, in particolare durante check-in e checkout, e al banco informazioni del Villaggio di Predazzo. 
        Io frequentavo la zona di Predazzo solo a livello sportivo e ricreativo, quindi prevalentemente solo le piste, viverla da un punto di vista semi-lavorativo e cittadino me ne ha fatto conoscere un aspetto più quotidiano. 
        Durante queste Olimpiadi ho scoperto alcune tradizioni olimpiche che hanno unito atleti e volontari: dallo scambio di spille alle collezioni di fascette, e ho anche partecipato attivamente. 
        Queste Olimpiadi mi hanno trasmesso uguaglianza: gli atleti sono persone come le altre, ognuno con il suo carattere e con le sue abitudini quotidiane. 
        Mi sono rimaste le storie degli altri volontari (chi sono, da dove vengono, cosa fanno nella vita esterna alle Olimpiadi) e l'indefinibile sensazione dell'aver vissuto in un luogo che nella realtà non esiste, al quale non si potrà tornare, ossia il Villaggio Olimpico appositamente creato, un po' quella specie di stonante nostalgia che in gallese è definita Hiraeth. 
        Nel villaggio si respirava un'atmosfera surreale, una dimensione di persone e luoghi unici in cui sono contenta di aver vissuto.`,
